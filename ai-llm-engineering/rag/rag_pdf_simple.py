...
chroma_persist_path = "/mnt/c/Temp/llm/chroma_persist"
...
class SimpleRAGSystem:
    ...
    def __init__(self, embedding_model="nomic", llm_model="openai"):
        self.embedding_model = embedding_model
        self.llm_model = llm_model

        # Initialize ChromaDB
        self.db = chromadb.PersistentClient(path=chroma_persist_path)
